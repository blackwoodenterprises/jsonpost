      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center justify-items-center max-w-6xl mx-auto">
              {/* React */}
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-green-700 group-hover:text-green-800"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-gray-700 group-hover:text-gray-800"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-teal-500 group-hover:text-teal-600"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-black dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-orange-500 group-hover:text-orange-600"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <div className="group cursor-pointer transition-transform hover:scale-110">
                <svg
                  className="w-12 h-12 text-green-600 group-hover:text-green-700"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-8 text-lg">
              And many more! JSONPost works with any technology that can make
              HTTP requests.
            </p>
          </div>
        </div>
