        ...
        <Card>
          ...
          <CardContent className="prose prose-gray dark:prose-invert max-w-none">
            <div className="space-y-6">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">3. Refund Conditions</h2>
              ...
              <section>
                ...
                <ol className="list-decimal pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                  <li>Contact our support team at{" "}
                    <a href="mailto:support@jsonpost.io" className="text-blue-600 dark:text-blue-400 hover:underline">
                      support@jsonpost.io
                    </a>
                  </li>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  within 5-10 business days. The exact timing may vary depending on your payment provider. 
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  You can cancel your subscription at any time through your account dashboard. Cancellation will 
                  prevent future billing, but you will retain access to the service until the end of your current 
                  billing period. Cancellation does not automatically qualify for a refund unless within the 
                  30-day guarantee period.
                </p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4">8. Downgrade Policy</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  If you downgrade your plan, the change will take effect at the start of your next billing cycle. 
                  We do not provide prorated refunds for downgrades, but you will continue to have access to your 
                  current plan features until the billing period ends.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  If you have a billing dispute or are unsatisfied with our refund decision, please contact our 
                  support team first. We are committed to resolving issues fairly and promptly. If we cannot 
                  reach a satisfactory resolution, you may pursue other legal remedies available to you.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  with an updated revision date. Changes to this policy will not affect refund requests made 
